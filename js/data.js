...
var CITIES = [
  ...
  },
  {
    ...
    practicalGuide: {
      en: '<p><strong>Getting there from Chengdu:</strong> High-speed rail from Chengdu East to Leshan station — 50 minutes, ¥54. Trains run every 20-30 minutes. The station is called "Leshan" (乐山站), not Leshan North. If you miss the train, buses from Chengdu Xinnanmen station take 2 hours (¥45).</p><p><strong>Giant Buddha logistics:</strong> Two ways to see it: (1) Walk the Nine-Turn Plank Path (九曲栈道) — ¥80, takes 1-2 hours, up-close view of the Buddha from head to toe. (2) Boat cruise — ¥70, 30 minutes, best full-body view from the river. Do both if you have time. The plank path gets crowded by 9 AM — arrive at 7:30 when the gates open.</p><p><strong>Day trip vs overnight:</strong> Leshan works as a day trip from Chengdu, but stay overnight if you want to eat properly and catch the night river view. Local hotels near the old town cost ¥150-300/night — simple but clean. The night food scene alone is worth the stay.</p><p><strong>Mount Emei logistics:</strong> Bus 601 from Leshan to Emeishan scenic area (1 hour, ¥12). Cable car to Golden Summit: ¥65 up, ¥55 down. Summit temperature is 10-15°C cooler than the base — bring a jacket even in summer. The monkeys are aggressive — do NOT carry open food or plastic bags they can see.</p>',
      zh: '<p><strong>成都到乐山：</strong>成都东站坐高铁到乐山站——50分钟，¥54。每20-30分钟一班。站名叫"乐山站"（不是乐山北站）。没赶上的话，成都新南门车站坐大巴2小时（¥45）。</p><p><strong>大佛怎么玩：</strong>两条路线：(1)走九曲栈道——¥80，1-2小时，从大佛头顶走到脚边，近距离感受体量。(2)坐游船——¥70，30分钟，江上看大佛全身最佳角度。有时间两个都做。栈道9点后人挤人——7:30开门就到。</p><p><strong>一日游还是住一晚？</strong>乐山可以从成都当天来回，但想吃好喝好再看个夜景观音就住一晚。老城区附近酒店¥150-300/晚——简单但干净。乐山的夜宵值得你住一晚。</p><p><strong>峨眉山怎么去：</strong>乐山坐601路到峨眉山景区（1小时，¥12）。索道上金顶：上¥65/下¥55。金顶温度比山下低10-15°C——夏天也带外套。峨眉山的猴子很凶——别让它们看到你手里有吃的或塑料袋。</p>'
    },
    honestTips: {
      en: '<p><strong>The plank path is NOT for everyone.</strong> The Nine-Turn Plank Path alongside the Giant Buddha is narrow, steep, and in peak season you could be stuck in a slow-moving line for 1+ hour. If you have mobility issues, claustrophobia, or severe heat sensitivity — skip the path and just take the boat cruise. The boat actually gives you a better photo anyway.</p><p><strong>Sweet Glazed Duck is best eaten fresh.</strong> It loses its crispiness within 2 hours of cooking. If you buy it as takeaway and eat it later at your hotel, the skin will be soft and chewy. Eat it at the shop, hot from the fryer, or skip it entirely.</p><p><strong>Emeishan summit is crowded at sunrise.</strong> Everyone wants that Golden Summit sunrise photo. The viewing platforms fill up by 5:30 AM. If you\'re not an early bird, skip the sunrise and come up at 10 AM when the crowds thin out — the sea of clouds is still there, and you\'ll have room to breathe.</p><p><strong>Mosquitoes at the Giant Buddha.</strong> The Buddha sits at a river confluence — lots of standing water = lots of mosquitoes. Bring repellent. You will be standing still on the plank path, and they will find you.</p>',
      zh: '<p><strong>九曲栈道不适合所有人。</strong>大佛旁的栈道窄、陡，旺季能堵在上面排一个多小时。如果你腿脚不方便、有幽闭恐惧症、或者怕热——别走栈道，坐游船就够了。说实话游船拍照角度更好。</p><p><strong>甜皮鸭必须趁热吃。</strong>出锅2小时后皮就软了不脆了。如果你买打包带回酒店吃，皮会又软又韧，你会怀疑它为什么这么有名。在店里趁热吃，刚从油锅捞出来就吃，否则别买。</p><p><strong>峨眉山金顶日出全是人。</strong>每个人都想看金顶日出。观景台早上5:30就站满了。起不来的话，10点再上山——云海还在，空气还好。</p><p><strong>大佛脚底蚊子多。</strong>大佛在三江汇流处——有水就有蚊子。带驱蚊液。你在栈道上站着不动，它们会来找你的。</p>'
    },
    localSecrets: {
      en: '<p><strong>Shizhong old street morning market.</strong> Behind the main tourist street, the old town comes alive at 6 AM with a farmers market that hasn\'t changed in decades. Fresh vegetables, live poultry, handmade tofu, and the best Shanxi rice noodles in town. The street food stalls here cost half of what you\'ll pay near the Buddha. Go hungry.</p><p><strong>Hejiang Tower (合江楼) at sunset.</strong> The best free view of Leshan. Climb this riverside tower for a panoramic view of the three rivers converging, with the Giant Buddha on your left and the old town on your right. Best time: 30 minutes before sunset. Bring a beer from the convenience store downstairs.</p><p><strong>Emeishan back-road hiking trail.</strong> Instead of the cable car, take the trail starting from Wannian Temple (万年寺) — a 4-hour hike through bamboo forests, past hidden waterfalls, and ending at the Golden Summit. You\'ll pass 10+ ancient temples that 99% of tourists never see. Start at 7 AM. Bring water and snacks — there are few shops on this route.</p><p><strong>Late-night Bobo chicken in the alleys.</strong> The best Bobo Chicken in Leshan isn\'t at a restaurant — it\'s the grandmother who sets up a single pot on a street corner near the old town at dusk and sells out in 2 hours. Look for the cart with a queue of locals, not tourists. ¥2 per skewer, cash only.</p>',
      zh: '<p><strong>市中老街早市。</strong>主街背后，早上6点就有几十年来没变过的菜市场。新鲜蔬菜、活禽、手工豆腐、全城最好吃的酸辣粉。这里的早摊价格只有大佛景区的一半。空腹去。</p><p><strong>合江楼看日落。</strong>乐山最好的免费观景台。爬上这座江边楼阁，三江汇流尽收眼底——左边是大佛，右边是老城。最佳时间：日落前30分钟。从楼下便利店带瓶啤酒上去。</p><p><strong>峨眉山后山徒步路线。</strong>不坐索道，从万年寺出发——4小时的竹林徒步，经过瀑布和10多座99%的游客没见过的古寺。早上7点出发。带水和干粮——这条路沿途小店很少。</p><p><strong>巷子里的夜宵钵钵鸡。</strong>乐山最好吃的钵钵鸡不在饭店——是黄昏时分在老城区街角支一个摊的大妈，两小时就卖光。找本地人在排队的那辆车，不是游客排的。¥2/串，只收现金。</p>'
    }
  }
];
window.DICT = DICT;
