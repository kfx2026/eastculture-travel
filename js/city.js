...
const cities = [
    ...
    { id: 'zhengzhou', name: 'Zhengzhou', nameZh: '郑州', desc: 'Ancient Shang capital — Shaolin Temple, Yellow River, and Henan cuisine', img: 'images/zhengzhou.jpg', tags: ['history', 'culture', 'food', 'kung fu'] },
    { id: 'kunming', name: 'Kunming', nameZh: '昆明', desc: 'City of Eternal Spring — Stone Forest, Dian Lake, and Crossing-the-Bridge Noodles', img: 'images/kunming.jpg', tags: ['nature', 'spring', 'food', 'ethnic'] },
    { id: 'wuhan', name: 'Wuhan', nameZh: '武汉', desc: 'Thoroughfare of nine provinces — Yellow Crane Tower, East Lake, and legendary Hot Dry Noodles', img: 'images/wuhan.jpg', tags: ['history', 'culture', 'food', 'river'] },
    { id: 'xiamen', name: 'Xiamen', nameZh: '厦门', desc: 'Garden on the Sea — Gulangyu Island, Nanputuo Temple, and world-famous Shacha Noodles', img: 'images/xiamen.jpg', tags: ['coastal', 'island', 'food', 'culture'] },
    { id: 'harbin', name: 'Harbin', nameZh: '哈尔滨', desc: "China's Ice City — Ice and Snow World, Saint Sophia Cathedral, and Russian heritage", img: 'images/harbin.jpg', tags: ['winter', 'ice', 'food', 'culture'] },
    { id: 'lhasa', name: 'Lhasa', nameZh: '拉萨', desc: "The Roof of the World — Potala Palace, Jokhang Temple, and Tibetan Buddhist heritage", img: 'images/lhasa.jpg', tags: ['plateau', 'buddhism', 'culture', 'food'] },
    { id: 'sanya', name: 'Sanya', nameZh: '三亚', desc: "China's Tropical Paradise — Yalong Bay, Tianya Haijiao, and Hainan's famous Wenchang Chicken", img: 'images/sanya.jpg', tags: ['beach', 'island', 'food', 'tropical'] }
];
