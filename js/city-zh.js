...
const cities = [
    ...
    { id: 'zhengzhou', name: 'Zhengzhou', nameZh: '郑州', desc: '商代古都 — 少林寺、黄河风景区、胡辣汤故乡', img: 'images/zhengzhou.jpg', tags: ['历史', '文化', '美食', '功夫'] },
    { id: 'kunming', name: 'Kunming', nameZh: '昆明', desc: '春城飞花 — 石林、滇池、过桥米线、民族风情', img: 'images/kunming.jpg', tags: ['自然', '春城', '美食', '民族'] },
    { id: 'wuhan', name: 'Wuhan', nameZh: '武汉', desc: '九省通衢 — 黄鹤楼、东湖樱花、热干面、江滩夜色', img: 'images/wuhan.jpg', tags: ['历史', '文化', '美食', '长江'] },
    { id: 'xiamen', name: 'Xiamen', nameZh: '厦门', desc: '海上花园 — 鼓浪屿、南普陀寺、沙茶面、环岛路海景', img: 'images/xiamen.jpg', tags: ['海滨', '海岛', '美食', '文化'] },
    { id: 'harbin', name: 'Harbin', nameZh: '哈尔滨', desc: '冰城 — 冰雪大世界、圣索菲亚大教堂、中央大街、俄式风情', img: 'images/harbin.jpg', tags: ['冰雪', '冬季', '美食', '文化'] },
    { id: 'lhasa', name: 'Lhasa', nameZh: '拉萨', desc: '世界屋脊 — 布达拉宫、大昭寺、八廓街、藏传佛教文化', img: 'images/lhasa.jpg', tags: ['高原', '佛教', '文化', '美食'] },
    { id: 'sanya', name: 'Sanya', nameZh: '三亚', desc: '热带天堂 — 亚龙湾、天涯海角、蜈支洲岛、海南文昌鸡', img: 'images/sanya.jpg', tags: ['海滨', '海岛', '美食', '热带'] }
];
